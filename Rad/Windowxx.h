...
#ifndef GET_POINT_LPARAM
#define GET_POINT_LPARAM(lp)                        GET_X_LPARAM(lp), GET_Y_LPARAM(lp)
#endif

#ifndef GET_SIZE_LPARAM
#define GET_SIZE_LPARAM(lp)                         GET_X_LPARAM(lp), GET_Y_LPARAM(lp)
#endif
...
#define HANDLEX_WM_NCHITTEST(wParam, lParam, fn) \
    (LRESULT)(DWORD)(UINT)(fn)(GET_POINT_LPARAM(lParam))
...
#define HANDLEX_WM_MOUSEMOVE(wParam, lParam, fn) \
    ((fn)(GET_POINT_LPARAM(lParam), (UINT)(wParam)), 0L)
...
#define HANDLEX_WM_MOUSEWHEEL(wParam, lParam, fn) \
    ((fn)(GET_POINT_LPARAM(lParam), (int)(short)HIWORD(wParam), (UINT)(short)LOWORD(wParam)), 0L)
...
#define HANDLEX_WM_CONTEXTMENU(wParam, lParam, fn) \
    ((fn)((HWND)(wParam), GET_POINT_LPARAM(lParam)), 0L)
